  ...
  <NavbarLayout title="Manage scripts permissions">
        ...
        <div>
          <ul class="list rounded-box">
            <RouterLink
              v-for="task in tasks"
              :key="task.id"
              :to="{ name: 'automation-and-task-permission', params: { id: task.id } }"
            >
    ...
    <dialog id="permissions_info" class="modal modal-sm">
      <div class="modal-box max-w-sm">
        ...
        <p>
          You are not showed in these lists since you already have every permission to modify and
          execute every task and automation.
        </p>
        <ul class="list-disc list-inside">
          <li>
            <span class="font-bold">Editlist</span>: every user inside it can edit the
            task/automation.
          </li>
          <li>
            <span class="font-bold">Whitelist</span>: a whitelisted user can execute the task even
            if he doesn't have all the necessary user-device permissions.
          </li>
          <li>
            <span class="font-bold">Blacklist</span>: A blacklisted user can't execute the task even
            if he has all the necessary user-device permissions.
          </li>
        </ul>
