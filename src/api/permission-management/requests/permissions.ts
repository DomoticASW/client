...
export async function getUserDevicesPermissions(
  email: string,
  token: string
): Promise<UserDevicePermission[]> {
...
export async function setUserDevicePermission(
  email: string,
  deviceId: string,
  token: string
): Promise<void> {
...
export async function deleteUserDevicePermission(
  email: string,
  deviceId: string,
  token: string
): Promise<void> {
