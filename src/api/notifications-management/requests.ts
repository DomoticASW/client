...
export async function subscribeForDeviceOfflineNotifications(
  deviceId: DeviceId,
  token: string
): Promise<void> {
...
export async function unsubscribeForDeviceOfflineNotifications(
  deviceId: DeviceId,
  token: string
): Promise<void> {
...
export async function isSubscribedForDeviceOfflineNotifications(
  deviceId: DeviceId,
  token: string
): Promise<boolean> {
...
export function openSocketIOForNotifications(
  email: string,
