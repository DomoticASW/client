...
import { deviceStatusDeserializer, isDeviceStatusDTO, type DeviceStatusDTO } from "./DeviceStatusDTO"
import { deviceEventDeserializer, isDeviceEventDTO, type DeviceEventDTO } from "./DeviceEventDTO"
import { deviceActionDeserializer, isDeviceActionDTO, type DeviceActionDTO } from "./DeviceActionDTO"
import { devicePropertyDeserializer, isDevicePropertyDTO, type DevicePropertyDTO } from "./DevicePropertyDTO"
...
export function isDeviceDTO(o: unknown): o is DeviceDTO {
  return o != undefined && typeof o == "object" &&
    ...
    "status" in o && isDeviceStatusDTO(o.status) &&
    "properties" in o && Array.isArray(o.properties) && o.properties.every(p => isDevicePropertyDTO(p)) &&
    "actions" in o && Array.isArray(o.actions) && o.actions.every(a => isDeviceActionDTO(a)) &&
    "events" in o && Array.isArray(o.events) && o.events.every(e => isDeviceEventDTO(e))
}
