...
export function isDevicePropertyDTO(o: unknown): o is DevicePropertyDTO {
  return o != undefined && typeof o == "object" &&
    ...
    "typeConstraints" in o && isTypeConstraintsDTO(o.typeConstraints)
}


export const devicePropertyDeserializer =
  Deserializer<DevicePropertyDTO, DeviceProperty<unknown>>(
    isDevicePropertyDTO,
    (dto) => {
      let value: unknown
